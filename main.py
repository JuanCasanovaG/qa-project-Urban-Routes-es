...
# -----------------------------------
# EJECUCIÓN DEL FLUJO COMPLETO (modo script)
# -----------------------------------
def main():
    # Se ejecuta el flujo completo usando la clase de tests a nivel de clase;
    # esto garantiza que se use una única sesión de Chrome para todas las pruebas.
    tests = TestUrbanRoutes()
    tests.setup_class()
    try:
